...
class FindDatosDePersonaParaCrearUsuario extends Select
{
	public function _init()
	{
		$this->_select
			 ...
			 ->columns(array(
				...
				'apellido' => 'apellido_persona',
			 	'documentos' => new Expression("string_agg(od.org_documento_id::text,',')"),	
	    ...
	    ->join(array('od' => 'org_documento'),new Expression('op.org_parte_id = od.org_parte_id'),array(),ZFSelect::JOIN_LEFT)
