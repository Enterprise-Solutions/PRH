...
class Get extends DbSelect
{
    public function _init()
    {
        $this->_select
             ...
             // Participantes
             ->join(array('aap' => 'act_actividad_participantes'), 'aa.act_actividad_id = aap.act_actividad_id', array('act_actividad_participantes_id', 'monto_participante' => new Expression("cm.simbolo || ' ' || aap.monto_participante"), 'monto_pagado' => new Expression("aap.monto_participante")), ZfSelect::JOIN_LEFT)
